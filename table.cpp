...
void table::set11to5(QDate date){
    ...
    qry.exec("select s.`H11` , o.`Car-det`,IF(o.`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(o.`flat` = '1' ,CONCAT('أرضيه:', o.`flat_color`), 'أرضيه : لا يوجد') , o.`Time2`  from `Order` AS o ,  `Sec` AS s where o.`Order-num` = s.`H11`  and s.`Date` = '"+sdate+"';");
    qry.first();
    ...
    qry.exec("select `H11a` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H11a` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ...
    qry.exec("select `H11b` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H11b` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ...
    qry.exec("select `H11c` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H11c` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ...
    qry.exec("select `H11d` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H11d` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ...
    qry.exec("select `H11e` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H11e` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ...
    qry.exec("select `H11` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H11` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
...
void table::set2to8(QDate date){
    ...
    sdate = english.toString(date.addDays(mon) , "yyyy-MM-dd");
    count(date.addDays(mon), ui->monday_flat);
    qry.exec("select s.`H2` , o.`Car-det`,IF(o.`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(o.`flat` = '1' ,CONCAT('أرضيه:', o.`flat_color`), 'أرضيه : لا يوجد') , o.`Time2`  from `Order` AS o ,  `Sec` AS s where o.`Order-num` = s.`H2`  and s.`Date` = '"+sdate+"';");
    qry.first();
    ui->monday1->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H2a` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H2a` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday2->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H2b` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H2b` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday3->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H2c` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H2c` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday4->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H2d` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H2d` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday5->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H2e` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H2e` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday6->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    sdate = english.toString(date.addDays(tue) , "yyyy-MM-dd");
    count(date.addDays(tue), ui->tue_flat);
    qry.exec("select `H2` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H2` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->tuesday1->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    qry.exec("select `Moagal`, `Done`,`Bouns` , `Delvtime`, `time` from `Order` , `Sec` where `Order-num` = `H2` and `H2` = "+qry.value(0).toString()+"");
    qry.first();
...
void table::set5to11(QDate date){
    ...
    sdate = english.toString(date.addDays(mon) , "yyyy-MM-dd");
    count(date.addDays(mon), ui->monday_flat);
    qry.exec("select s.`H5` , o.`Car-det`,IF(o.`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(o.`flat` = '1' ,CONCAT('أرضيه:', o.`flat_color`), 'أرضيه : لا يوجد') , o.`Time2`  from `Order` AS o ,  `Sec` AS s where o.`Order-num` = s.`H5`  and s.`Date` = '"+sdate+"';");
    qry.first();
    ui->monday1->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H5a` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H5a` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday2->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H5b` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H5b` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday3->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H5c` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H5c` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday4->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H5d` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H5d` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday5->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    qry.exec("select `H5e` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H5e` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->monday6->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    ...
    sdate = english.toString(date.addDays(tue) , "yyyy-MM-dd");
    count(date.addDays(tue), ui->tue_flat);
    qry.exec("select `H5` ,`Car-det`,IF(`wheel` = '1', 'طاره : نعم', 'طاره : لا يوجد'), if(`flat` = '1' ,CONCAT('أرضيه:', `flat_color`), 'أرضيه : لا يوجد') , `Time2`  from `Order` , `Customer` , `Sec` where `Order-num` = `H5` and `C-code` = `Cnum`  and `Date` = '"+sdate+"';");
    qry.first();
    ui->tuesday1->setText(qry.value(0).toString() + "\n" + qry.value(1).toString() + "\n" +  qry.value(2).toString() + "\n"  + qry.value(3).toString() + "\n"  + qry.value(4).toString() );
    qry.exec("select `Moagal`, `Done`,`Bouns` , `Delvtime`, `time` from `Order` , `Sec` where `Order-num` = `H5` and `H5` = "+qry.value(0).toString()+"");
    qry.first();
