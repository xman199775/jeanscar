...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "QtRPT examples", nullptr));
        actionPrint->setText(QApplication::translate("MainWindow", "Print", nullptr));
        groupBox->setTitle(QApplication::translate("MainWindow", "Select example", nullptr));
        rBtn1->setText(QApplication::translate("MainWindow", "Invoice report (data from grid)", nullptr));
        rBtn2->setText(QApplication::translate("MainWindow", "Two datasource report", nullptr));
        rBtn3->setText(QApplication::translate("MainWindow", "Embedded report widget", nullptr));
        rBtn4->setText(QApplication::translate("MainWindow", "Report with condition (Printable and highlighting fields)", nullptr));
        rBtn5->setText(QApplication::translate("MainWindow", "Report with mathematics and aggregate functions", nullptr));
        rBtn6a->setText(QApplication::translate("MainWindow", "Report with grouping data in Master Data Band 1", nullptr));
        rBtn6b->setText(QApplication::translate("MainWindow", "Report with grouping data in Master Data Band 2", nullptr));
        rBtn7->setText(QApplication::translate("MainWindow", "Report with Diagram", nullptr));
        rBtn8->setText(QApplication::translate("MainWindow", "Report with AutoHeight", nullptr));
        rBtn9->setText(QApplication::translate("MainWindow", "Report with Drawing", nullptr));
        rBtn10->setText(QApplication::translate("MainWindow", "Report with SQL query to SQLITE DB", nullptr));
        rBtn11->setText(QApplication::translate("MainWindow", "Barcode generator", nullptr));
        rBtn12->setText(QApplication::translate("MainWindow", "Report with RichText Fields", nullptr));
        rBtnRussian->setText(QApplication::translate("MainWindow", "Russian invaders", nullptr));
        rBtn13->setText(QApplication::translate("MainWindow", "Report's control from user application", nullptr));
        rBtn14->setText(QApplication::translate("MainWindow", "Creation of the report from the user application without XML file", nullptr));
        rBtn15->setText(QApplication::translate("MainWindow", "Generate PDF file", nullptr));
        rBtn16->setText(QApplication::translate("MainWindow", "Application defined SQL parameters and images from SQLITE DB table", nullptr));
        rBtn17->setText(QApplication::translate("MainWindow", "Buil in functions and system variables", nullptr));
        rBtn18->setText(QApplication::translate("MainWindow", "CrossTab report", nullptr));
        label->setText(QString());
        btnShow->setText(QApplication::translate("MainWindow", "Show", nullptr));
    } // retranslateUi
